...
import AddWidget from "../components/addWidgets";
import Widgets from "../components/showWidgets";
export default function Home() {
  return (
    <div className="max-width">
      <div className=" text-gray-800 w-10/12 mx-auto ">
        <div className="container flex flex-col justify-center p-2 mx-auto  lg:flex-row lg:justify-between">
          <div className="flex items-center justify-center p-1 md:p-6 md:mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            <img
              src="https://ouch-cdn2.icons8.com/32d8uYOQCgK3leUEkO_a1TlcA0XY5XJA-uyDMDFaVo0/rs:fit:368:368/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvNzMw/LzMwNjBjY2ExLTU5/MWMtNDkyNS05YTM3/LTllZjU0NDEzMWZj/YS5wbmc.png"
              alt=""
          ...
          <div className="flex flex-col justify-center  md:p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold leading-none sm:text-6xl">
              Best of
              <span className="text-cyan-600"> Analytics Dash</span>boards
            </h1>
            <p className="mt-6 mb-8 text-lg sm:mb-12">
              Get the best dashboard for your business{" "}
              <br className="hidden md:inline lg:hidden" />
              with AI features and much more.
            </p>
            <Link to="/dashboard">
              <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                <a
                  ...
                  href="#"
                  className="px-8 py-3 text-lg font-semibold rounded bg-cyan-600 text-white"
                >
                  Start Now
                </a>
              </div>
      ...
      <div className="mx-auto w-11/12 mt-4 md:mt-0 px-4  sm:px-6  lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-gray-500 sm:text-xl">
            Best for business with AI features for better analytics. User
            friendly captivating UI with multi dashboards features.
          </p>
        </div>
      ...
      <section className="bg-white">
        <div className="mx-auto w-11/12 px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="text-cyan-500">
              <p className="text-2xl font-bold">Accuknox</p>
            </div>
          ...
          <p className="text-xs text-gray-500">
            &copy; 2024. Accuknox. All rights reserved.
          </p>
        </div>
      </footer>
      {/*  <Widgets />
